 ...
 * @author David
 */
public class FrameLlistaPartides extends javax.swing.JFrame {
    ...
    private void inici(RetornadorString ret, GameManagerController gmc, HidatoManagerController hmc) {
        this.ret = ret;
        this.gmc = gmc;
        this.hmc = hmc;
        label_nom.setText("");
    ...
    private void seleccio() {
        seguir = false;
        String gameName = (gmc.getGame(selected)).getName();
        if (gameName == null) {
            msgError("No s'ha trobat la partida");
            return;
        }
        //carreguem el hidato del game en el controlador
        hmc.loadHidato(gmc.getGame(gameName).getHidato().getBoardName());
